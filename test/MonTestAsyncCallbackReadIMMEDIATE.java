...
public class MonTestAsyncCallbackReadIMMEDIATE {
    ...
    public static void main(String[] a) {
        ...
        linda.write(t1); 
        //mes callbacks : [integer, string] Read MyCallback 
        ...
        linda.write(t3); 
        //exécution de la méthode call (affichage string)
        //mon tuple space : [bonjour, 6] [aurevoir 15] [1 foo]
